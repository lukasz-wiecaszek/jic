...
\*===========================================================================*/
const h264_structure* parser_h264::get_structure(parser_h264_structure_e structure, int id)
{
    const h264_structure* retval = nullptr;

    switch (structure) {
        case parser_h264_structure_e::AUD:
            retval = &m_aud;
            break;

        case parser_h264_structure_e::SPS:
        ...
        case parser_h264_structure_e::PPS:
            if (id == H264_PARSER_STRUCTURE_ID_RECENT)
                id = m_recent_pps;
        ...
        case parser_h264_structure_e::SEI:
            retval = &m_sei;
            break;

        case parser_h264_structure_e::SLICE_HEADER:
            retval = &m_slice_header;
            break;

        case parser_h264_structure_e::SLICE_DATA:
            return nullptr;
...
\*===========================================================================*/
bool parser_h264::find_next_start_code()
{
...
bool parser_h264::parse_scaling_matrices(istream_be& s, h264::scaling_matrices& sm, bool parse8x8, uint32_t chroma_format_idc)
{
    bool retval = false;
...
bool parser_h264::parse_hrd_parameters(istream_be& s, h264::hrd_parameters& hrd)
{
    bool retval = false;
...
bool parser_h264::parse_vui_parameters(istream_be& s, h264::vui_parameters& vui)
{
    bool retval = false;
...
bool parser_h264::parse_ref_pic_list_modification(istream_be& s, h264::ref_pic_list_modification& rplm)
{
    bool retval = false;
...
static void parser_h264_parse_pred_weight_table_lx(
...
bool parser_h264::parse_pred_weight_table(istream_be& s, h264::pred_weight_table& pwt)
{
    bool retval = false;
    ...
    do {
        ...
        parser_h264_parse_pred_weight_table_lx(s, pwt.l0, pwt.num_ref_idx_l0_active_minus1, pwt.chroma_components_present);

        if (s.status() != ISTREAM_STATUS_OK)
            break;

        if (h264::slice_type_e::B == pwt.slice_type)
            parser_h264_parse_pred_weight_table_lx(s, pwt.l1, pwt.num_ref_idx_l1_active_minus1, pwt.chroma_components_present);
...
bool parser_h264::parse_dec_ref_pic_marking_idr(istream_be& s, h264::dec_ref_pic_marking_idr& drpm)
{
    bool retval = false;
...
bool parser_h264::parse_dec_ref_pic_marking_nonidr(istream_be& s, h264::dec_ref_pic_marking_nonidr& drpm)
{
    bool retval = false;
...
parser_h264_status_e parser_h264::parse_aud(istream_be& s)
{
    parser_h264_status_e retval = parser_h264_status_e::NAL_UNIT_CORRUPTED;
    ...
    do {
        ...
        aud.set_valid(true);
        retval = parser_h264_status_e::AUD_PARSED;
    } while (0);

    return retval;
}

parser_h264_status_e parser_h264::parse_sps(istream_be& s)
{
    parser_h264_status_e retval = parser_h264_status_e::NAL_UNIT_CORRUPTED;
    ...
    do {
        ...
        sps.set_valid(true);
        retval = parser_h264_status_e::SPS_PARSED;
    } while (0);

    return retval;
}

parser_h264_status_e parser_h264::parse_pps(istream_be& s)
{
    parser_h264_status_e retval = parser_h264_status_e::NAL_UNIT_CORRUPTED;
    ...
    do {
        ...
        pps.set_valid(true);
        retval = parser_h264_status_e::PPS_PARSED;
    } while (0);

    return retval;
}

parser_h264_status_e parser_h264::parse_sei(istream_be& s)
{
    parser_h264_status_e retval = parser_h264_status_e::NAL_UNIT_CORRUPTED;
    ...
    do {
        ...
        sei.set_valid(true);
        retval = parser_h264_status_e::SEI_PARSED;
    } while (0);

    return retval;
}

parser_h264_status_e parser_h264::parse_slice_header(istream_be& s, uint32_t nal_ref_idc, uint32_t nal_unit_type)
{
    parser_h264_status_e retval = parser_h264_status_e::NAL_UNIT_CORRUPTED;
    ...
    do {
        ...
        retval = parser_h264_status_e::SLICE_PARSED;
    } while (0);

    return retval;
}

parser_h264_status_e parser_h264::parse_slice_data(istream_be& s)
{
    UNUSED(s); //TODO: just deliver implementation

    return parser_h264_status_e::NAL_UNIT_CORRUPTED;
}

parser_h264_status_e parser_h264::parse_nal_unit(istream_be& s)
{
    uint8_t nal_header;
    ...
    return parser_h264_status_e::NAL_UNIT_SKIPPED;
}

parser_h264_status_e parser_h264::parse_nal_units()
{
    parser_h264_status_e status = parser_h264_status_e::NEED_BYTES;

    return status;
}

parser_h264_status_e parser_h264::parse_byte_stream_nal_units()
{
    parser_h264_status_e status = parser_h264_status_e::NEED_BYTES;
    ...
    if ((num_bytes_in_nal_unit = find_nal_unit()) > 0) {
        ...
        if (rbsp_size > 0) {
            ...
            status = parser_h264_status_e::NAL_UNIT_CORRUPTED;
